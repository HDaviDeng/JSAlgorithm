...
//We provide Math.max with the lenth of each word as argument, and it will simply return the highest of all.
...
//Then, we will make another array, made from the lengths of each element of the 

//str.split(" ")array with map().
